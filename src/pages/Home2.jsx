    ...
    >
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between bg-black p-10 rounded-2xl shadow-lg mt-20 w-[90%] gap-16 ">
        ...
        <div className="space-y-6 lg:w-1/2 ">
          ...
          <button className="px-5 py-2 text-xl font-semibold text-white transition rounded-full bg-fuchsia-900 hover:bg-fuchsia-500" onClick={() => navigate("/courses/web-dev-cohort")}>
            Join now
          </button>
        </div>
